(() => {
  ...
  const PROGRAM_EVENTS = [
    ...
    {
      id: "tue-office-evening",
      title: "Неформальный вечер в офисе",
      day: "2026-06-30",
      time: "19:30-22:30",
      category: "social",
      location: "SOK 306-307",
      description: "Смотрим матч ЧМ по футболу, берем снеки и пиво."
    },
    {
      id: "wed-work",
      title: "Рабочий день в SOK",
    ...
    {
      id: "sat-moscow-day",
      title: "Пикник + гуляем по Москве + велосипеды",
      day: "2026-07-04",
      time: "12:00-20:00",
      category: "free",
      location: "Москва / Парк Горького",
      description: "Единый свободный день: пикник, прогулка по Москве и велосипеды."
    },
    {
      id: "sun-wrap",
      title: "Разъезд",
  ...
  const ACTIVITY_IDEAS = [
    ...
    },
    {
      ...
      text: "Падел в среду, боулинг и бильярд в пятницу, суббота одним слотом: пикник, Москва и велосипеды."
    },
    {
      tag: "Суббота",
      title: "Никакой работы",
      text: "Один большой слот: пикник, прогулка по Москве и велосипеды."
    }
  ];
