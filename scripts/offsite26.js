(() => {
  ...
  const PROGRAM_EVENTS = [
    ...
    {
      id: "sat-gorky-bikes",
      title: "Пикник в Парке Горького + катаемся на велосипедах",
      day: "2026-07-04",
      time: "16:00-20:00",
      category: "sport",
      location: "Парк Горького",
      description: "Пикник в Парке Горького, потом спокойно катаемся на велосипедах."
    },
    {
      id: "sun-wrap",
      title: "Разъезд",
  ...
  const ACTIVITY_IDEAS = [
    ...
    },
    {
      ...
      text: "Падел в среду, боулинг и бильярд в пятницу, в субботу парк Горького и велосипеды."
    },
    {
      tag: "Суббота",
      title: "Никакой работы",
      text: "Гуляем, отдыхаем, делаем пикник в Парке Горького и катаемся на велосипедах."
    }
  ];
